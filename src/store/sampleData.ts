import type { Page, Template, Workspace, PageStatus, BlockType, ThemeId, PuckPageData } from '@/types/cms';
...
export const SAMPLE_TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    isDefault: true,
    blocks: [
      { id: 'tpl-lf-1', type: 'hero', content: { html: '<h1>제품 이름</h1><p>제품의 핵심 가치를 한 줄로 설명하세요</p>', title: '제품 이름', subtitle: '제품의 핵심 가치를 한 줄로 설명하세요' }, order: 0 },
      { id: 'tpl-lf-2', type: 'features', content: { html: '<h2>핵심 기능</h2><ul><li>기능 1</li><li>기능 2</li><li>기능 3</li></ul>' }, order: 1 },
      { id: 'tpl-lf-3', type: 'testimonial', content: { html: '<h2>고객 후기</h2><blockquote><p>"정말 훌륭한 제품입니다." — 홍길동, 기업명</p></blockquote>' }, order: 2 },
      { id: 'tpl-lf-4', type: 'pricing', content: { html: '<h2>요금제</h2><p><strong>Free</strong> — 무료 | <strong>Pro</strong> — 월 ₩15,000 | <strong>Enterprise</strong> — 문의</p>' }, order: 3 },
      { id: 'tpl-lf-5', type: 'cta', content: { html: '<h2>지금 시작하세요</h2><p>신용카드 없이 무료로 시작하세요.</p>' }, order: 4 },
    ],
  },
];
...
export const SAMPLE_PAGES: Page[] = [
  {
    ...
    puckData: {
      content: [
        {
          type: 'HeroBlock',
          props: { id: 'hero-page1-1', title: 'Your Product Name', subtitle: 'The best solution for your needs', ctaText: 'Get Started', ctaLink: '/login', secondaryText: '', secondaryLink: '', background: 'gradient', badge: 'Landing Page', stats: [] },
        },
        {
          type: 'FeaturesBlock',
          props: { id: 'features-page1-1', title: 'Why Choose Us', subtitle: 'Everything you need in one platform.', layout: 'grid-3', features: [{ icon: 'Zap', title: 'Fast', description: 'Lightning-fast performance.' }, { icon: 'Shield', title: 'Reliable', description: 'Built for stability.' }, { icon: 'Layers', title: 'Scalable', description: 'Grows with your team.' }] },
        },
        {
          type: 'CTABlock',
          props: { id: 'cta-page1-1', title: 'Ready to Start?', subtitle: 'Try for free today.', ctaText: 'Try for Free', ctaLink: '/login', secondaryText: '', secondaryLink: '', background: 'gradient' },
        },
      ],
  ...
  },
  {
    ...
    puckData: {
      content: [
        { type: 'HeadingBlock', props: { text: 'Getting Started', level: 1, align: 'left', color: 'default', subtitle: 'Welcome to FlowCMS' } },
        { type: 'TextBlock', props: { content: 'Welcome to the documentation. This guide will help you get started with FlowCMS and explore its features.', align: 'left', size: 'base', maxWidth: 'prose', color: 'default' } },
        { type: 'CodeBlock', props: { code: 'npm install flowcms', language: 'bash', filename: 'terminal', showLineNumbers: false } },
      ],
  ...
  },
  {
    ...
    puckData: {
      content: [
        { type: 'HeroBlock', props: { title: 'Product Name v2', subtitle: 'The ultimate solution for modern teams', ctaText: 'Learn More', ctaLink: '/login', secondaryText: '', background: 'gradient', badge: 'New Release', stats: [] } },
        { type: 'FeaturesBlock', props: { title: 'Key Features', subtitle: 'What makes v2 special.', layout: 'grid-2', features: [{ icon: 'Zap', title: 'Performance', description: '2x faster than before.' }, { icon: 'Palette', title: 'New Design', description: 'Completely redesigned UI.' }] } },
        { type: 'TestimonialsBlock', props: { title: 'What customers say', subtitle: '', background: 'white', columns: 2, testimonials: [{ name: 'Jane Doe', title: 'CTO', text: 'Amazing product upgrade!', rating: 5, avatarSeed: 'jane' }, { name: 'John Kim', title: 'Developer', text: 'The new features are incredible.', rating: 5, avatarSeed: 'john' }] } },
        { type: 'PricingBlock', props: { title: 'Simple Pricing', subtitle: 'Choose the plan that fits your needs.', background: 'gray', plans: [{ name: 'Free', price: '$0', period: '/mo', description: 'For individuals', features: '5 pages\nBasic templates', featured: false }, { name: 'Pro', price: '$15', period: '/mo', description: 'For teams', features: 'Unlimited pages\nAll templates\nPriority support', featured: true }, { name: 'Enterprise', price: 'Contact', period: '', description: 'For organizations', features: 'Everything in Pro\nSSO\nDedicated support', featured: false }] } },
      ],
