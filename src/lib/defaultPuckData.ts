  ...
  content: [
    ...
    },
    {
      ...
      props: {
        ...
        testimonials: [
          { name: '김지영', title: 'Product Manager', text: 'FlowCMS 덕분에 콘텐츠 발행 속도가 3배 빨라졌어요.', rating: 5 },
          { name: 'James Park', title: 'CEO at StartupXYZ', text: 'The template system is incredible. We launched our entire product site in one day.', rating: 5 },
          { name: '이민수', title: 'Tech Lead', text: 'API 연동이 너무 쉬워서 놀랐습니다.', rating: 5 },
        ],
      },
    },
    {
